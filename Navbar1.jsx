  ...
  return (
    ...
    <div id="home"></div>
     <div className="container-fluid">
        <div className="row hh" style={{background:'linear-gradient(darkgreen,green)',color:'white'}}>
            <div className="col-md-6">
            <p className="hh">CREATE HELPING TENDENCY</p>
            </div>
          
          <div className="col-md-6 text-end d-md-block d-none m">
            <a href='#'>
    ...
    <Routes>
      ...
      <Route path='/adm' element={<Administor/>}></Route>
      <Route path='/admins' element={<Admmain/>}></Route>
